    ...
    <div className="welcome-container">
      <TypeAnimation
        sequence={[
          ...
          1000,
          'Pedro Maia da Costa Silva - Engenheiro de Software',
          2000,
        ]}
        wrapper="h1"
        cursor={true}
      ...
      <div className="static-welcome">
        ...
        <p>Desenvolvedor em formação, apaixonado por criar automações eficientes e soluções inovadoras.</p>
        
        <ul className="info-list">
          <li>
            <IoFlash className="icon" style={{ color: '#f3d956' }} />
            Engenharia de Software | Estagiário de Desenvolvimento de Software
          </li>
          <li>
